      ...
      <div className="w-[40%] bg-slate-100 rounded-lg border-[2px] border-slate-300">
        ...
        <div className="flex pl-12 my-2">
          <input
            ...
            placeholder="Enter amount of IBT"
          />
          <p className="justify-center flex mx-5 mt-2">IBT</p>
        </div>
        ...
        <div className="flex pl-12 my-2">
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="flex text-right ml-40 text-red-600">Disabled</div>
          </div>
        </div>
...
export default WithdrawPageIBT;
